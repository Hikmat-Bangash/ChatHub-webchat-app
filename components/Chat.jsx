...
const Chat = ({ setActive, activeChat }) => {
  ...
  return (
    <div className="h-[100vh] w-[100%] sm:w-[75vw] md:w-[75vw] lg:w-[75vw] relative">
      <header className="flex items-center justify-between px-4 sm:px-6 md:px-6 lg:px-6 bg-green-500 h-[70px] w-[100%] sm:w-[75vw] md:w-[75vw] lg:w-[75vw] rounded-b-3xl sm:rounded-none md:rounded-none lg:rounded-none fixed top-0 z-30">
        {activeChat ? (
          <>
                ...
                >
                  ...
                  {message.senderEmail === activeUser.email ? (
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex flex-col bg-primarycolor-400 text-white text-[14px] px-[18px] py-2 rounded-lg rounded-tr-none mt-2">
          ...
          <div className="flex flex-col items-center justify-center gap-2 w-full h-full">
            ...
            <p className="pt-32">
              ...
              <a
                ...
                className="text-green-500 ml-1 underline cursor-pointer"
              >
                 Hikmat Bangash
              </a>
            </p>
