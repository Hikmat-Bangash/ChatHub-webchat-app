...
const chatsAll = ({ setActive, activeChat }) => {
  ...
  return (
    <div className="h-[100vh] w-[100%] sm:w-[25vw] md:w-[25vw] lg:w-[25vw] relative border-r-2 border-primarycolor-300">
      <header className="flex items-center justify-between px-6 bg-green-500 w-[100%] sm:w-[25vw] md:w-[25vw] lg:w-[25vw] h-[70px] rounded-b-3xl sm:rounded-none md:rounded-none lg:rounded-none fixed top-0 z-30 border-r-2 border-green-400">
        ...
        <input
          ...
          className="outline-none rounded-full bg-white w-[23%] sm:w-[23%] md:w-[23%] lg:[15%] focus:w-[60%] py-2 px-4 transition-all"
